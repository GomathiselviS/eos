...
class TestEosLldpGlobalModule(TestEosModule):
    ...
    def test_eos_lldp_global_merged(self):
        ...
        commands = ['lldp holdtime 100', 'lldp tlv-select system-description',
    ...
    def test_eos_lldp_global_replaced(self):
        ...
        commands = ['no lldp holdtime', 'no lldp reinit',
                    'no lldp timer', 'lldp holdtime 100',
    ...
    def test_eos_lldp_global_deleted(self):
        ...
        commands = ['no lldp holdtime', 'no lldp reinit',
                    'no lldp timer', 'lldp tlv-select management-address',
                    'lldp tlv-select system-description']
        self.execute_module(changed=True, commands=commands)

    def test_eos_lldp_global_parsed(self):
        commands = ['lldp holdtime 100', 'lldp tlv-select system-description',
                    'lldp reinit 5', 'no lldp tlv-select port-description']
        parsed_str = "\n".join(commands)
    ...
    def test_eos_lldp_global_rendered(self):
        ...
        commands = ['lldp holdtime 100', 'lldp reinit 5',
                    'lldp timer 400', 'lldp tlv-select system-description',
                    'no lldp tlv-select port-description', 'no lldp tlv-select management-address']
        result = self.execute_module(changed=False)
        self.assertEqual(
